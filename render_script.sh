...
declare -A renderers
renderers=(
    ["Cycles"]="cycles"                         # 4.2.0 + OpenUSD 24.05 (GHCR candidate)
)
...
problematic_combinations=(
    ["Cycles,scenes/MoanaIsland/usd/island.usda"]=1 # Follow-up lane Aug 3: OOM-killed (exit 137, ~29 GB RSS, pod cgroup cap), no image
    ["Cycles,scenes/ALab/ALab/entry.usda"]=1 # Follow-up lane Aug 3: Segmentation fault (core dumped) at 0:34, no image
)
