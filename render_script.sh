...
declare -A renderers
renderers=(
    ["Cycles"]="cycles"                         # 5.0.0 + OpenUSD 25.08 (GHCR candidate)
)
...
problematic_combinations=(
    ...
    ["Cycles,scenes/ALab/ALab/entry.usda"]=1 # Follow-up lane Aug 3: Segmentation fault (core dumped) at 0:42, no image
)
