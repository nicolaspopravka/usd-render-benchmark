...
declare -A renderers
renderers=(
    ["Cycles"]="cycles"                         # 3.6.0 + OpenUSD 23.08
)
...
problematic_combinations=(
    ["Cycles,scenes/MoanaIsland/usd/island.usda"]=1 # /tmp/rez_context_80p6nv9v/context.sh: line 48: 380 Killed /workspace/usd-render-benchmark/tools/usdrecord_egl.py "$@"
    ["Cycles,scenes/ALab/ALab/entry.usda"]=1 # /tmp/rez_context_bgcifc7m/context.sh: line 48: 301 Segmentation fault (core dumped) /workspace/usd-render-benchmark/tools/usdrecord_egl.py "$@"
)
